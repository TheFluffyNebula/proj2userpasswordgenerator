...
public class App 
{
    public static void main( String[] args )
    {
        ...
        // original output for substring(indexes 0-1): p1pp, 4 chars probably not strong enough
        // changed to color, first name, last initial, pet name first 3 chars, email first 3 chars
        // for the second it is alternating letters between the first name and the fruit
        ...
        System.out.println("hello person2, what is your favorite fruit?");
        String favFruit2 = scan.nextLine();
        String p2Password = person2.generatePassword2(favFruit2);
